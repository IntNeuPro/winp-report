...
scintillator detectors at the JPARC-MLF (1~MW) 3~GeV spallation
...
contribution to JPARC-E56 will be the dilute Gd-loaded liquid
scintillator, which represents an important technological R\&D step in
producing doped scintillator for detecting both Cherenkov and
scintillation signals. This effort will fit well into the FOA scope
with an estimated cost of \$1.5M.

The JPARC-MLF beam also uniquely allows the possibility to study kaon
decay-at-rest (KDAR)~\cite{KDAR,KDAR1} muon neutrinos 
